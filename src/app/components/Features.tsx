                       ...
                       <div>
                         <section className="text-gray-600 body-font">
                           <div className="container px-5 py-24 mx-auto">
                             ...
                             <div className="flex flex-wrap justify-center gap-6">
                               {featureData.map(({ Icon, title, description, adjustDescription }) => (
                                 <div
                                   key={title}
                                   className="p-6 bg-gray-100 hover:bg-gray-200 transition duration-300 rounded-lg shadow-lg w-full sm:w-1/2 lg:w-1/5 flex flex-col justify-between"
                                 >
                                   <div className="flex flex-col items-center gap-4 mb-4">
                                     <div className="text-5xl text-gray-700">
                                       <Icon />
                                     ...
                                     <p className={`text-gray-700 text-center ${adjustDescription ? 'mt-4' : ''}`}>
                                       {description}
                                     </p>
                                   </div>
                                 </div>

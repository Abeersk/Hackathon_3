  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold text-center mb-8">Sopping Cart <MdOutlineShoppingCart/></h1>
        {cartItems.length === 0 ? (
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <div className="mt-6 text-right">
              <button
                ...
                className="bg-indigo-950 text-white px-6 py-2 rounded hover:bg-blue-600"
              >
                Proceed to Checkout
              </button>
            </div>
